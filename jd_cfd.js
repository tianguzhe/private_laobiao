...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://raw.githubusercontent.com/tianguzhe/private_laobiao/master/shareCodes/cfd.json")
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('http://cdn.annnibb.me/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/tianguzhe/private_laobiao@master/shareCodes/cfd.json')
