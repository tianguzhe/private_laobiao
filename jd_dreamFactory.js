...
async function joinLeaderTuan() {
  ...
  if (!res) res = await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/tianguzhe/private_laobiao@master/shareCodes/jd_updateFactoryTuanId.json');
...
function updateTuanIdsCDN(url = 'https://raw.githubusercontent.com/tianguzhe/private_laobiao/master/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    const options = {
  ...
  return new Promise(async resolve => {
    ...
    if (!tuanActiveId) {
      ...
      if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
        ...
        if (!$.tuanConfigs) {
          await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/tianguzhe/private_laobiao@master/shareCodes/jd_updateFactoryTuanId.json');
          if ($.tuanConfigs && $.tuanConfigs['tuanActiveId']) {
            tuanActiveId = $.tuanConfigs['tuanActiveId'];
            console.log(`拼团活动ID: 获取成功 ${tuanActiveId}\n`)
          } else {
