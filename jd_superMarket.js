  ...
  if (smtg_getTeamPkDetailInfoRes && smtg_getTeamPkDetailInfoRes.data.bizCode === 0) {
    ...
    if (joinStatus === 0) {
      if (joinPkTeam === 'true') {
        ...
        await updatePkActivityIdCDN('https://cdn.jsdelivr.net/gh/tianguzhe/private_laobiao@master/shareCodes/jd_updateTeam.json');
